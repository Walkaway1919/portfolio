...
export const Greeting = () => {
    return <div className="greeting">
        ...
        <div className="greeting__bio">
            <p>Меня зовут Юлия Кунашева и я сертифицированный JavaScript-разработчик Junior+ уровня.</p>
            <p>Мой стек:</p>
            <ul>
            ...
            <p>За посление польора года я прошла более 10 курсов по frontend-разработке.</p>
